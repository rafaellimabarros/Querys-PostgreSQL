...
LEFT JOIN 
financial_receivable_title_occurrences AS fev ON (fat.id = fev.financial_receivable_title_id) AND fev.date > '2022-08-01' 
AND fev.financial_title_occurrence_type_id IN (1, 2, 3, 5)
