...
WHERE pcii.crm_discart_motive_id IS NOT NULL AND DATE(pcii.created) BETWEEN '2022-07-01' AND '2022-07-29'
AND pcii.situation NOT IN  (3,4) AND ppg.people_group_id IN (11,14,16)
