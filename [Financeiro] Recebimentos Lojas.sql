...
WHERE fatr.receipt_date BETWEEN '2022-05-01' AND '2022-11-30'
AND fat.title LIKE '%FAT%'
AND vu.profile_id IN (87,65,48,47,37,36,30,114,115)

OR fatr.receipt_date BETWEEN '2022-05-01' AND '2022-11-30'
...
forma_pagamento, operacao_contrato, valor_contrato, operacao_titulo, perfil