...
LEFT JOIN 
financial_receivable_title_occurrences AS fev ON (fat.id = fev.financial_receivable_title_id) AND fev.date > '2022-06-01' AND fev.financial_title_occurrence_type_id IN (1, 2, 3, 5)
INNER JOIN 
...
AND fatr.receipt_date BETWEEN '2022-06-01' AND '2022-06-11'
