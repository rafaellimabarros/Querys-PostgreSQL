...
WHERE fatr.receipt_date BETWEEN '2023-05-01' AND '2023-05-31'
AND fat.title LIKE '%FAT%'

OR fatr.receipt_date BETWEEN '2023-05-01' AND '2023-05-31'
...
forma_pagamento, operacao_contrato, valor_contrato,operacao_titulo